...
//       description: " Institut Spécialisé de Technologie Appliquée HH1 Formation Full-Stack complète • 2023-2025 "
//     },
//     {
...
const About = () => {
  const highlights = [
    {
      icon: <Users className="text-primary" size={24} />,
      title: "Langues",
      description: "Anglais - Français - Arabe"
    },
    {
      icon: <Target className="text-primary" size={24} />,
      title: "Objectif",
  ...
  const softSkills = ['Adaptabilité', 'Travail en équipe', 'Écoute active', 'Empathie', 'Organisation', 'Leadership'];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 slide-up">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              {/* Soft Skills Card */}
              <Card className="project-card border-0 sm:col-span-2">
                <CardContent className="p-6">
                  <h4 className="text-lg font-semibold text-center mb-4">Compétences comportementales</h4>
